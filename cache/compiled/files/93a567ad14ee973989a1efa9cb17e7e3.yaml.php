...
return [
    ...
    'filename' => '/home/nat/Documents/Le Drakkar/www.ledrakkar-coworking.fr/user/themes/ledrakkar/blueprints.yaml',
    'modified' => 1683127733,
    'size' => 4107,
    'data' => [
        'name' => 'Ledrakkar',
        ...
        'homepage' => 'https://github.com/getgrav/grav-theme-ledrakkar',
        'demo' => 'https://demo.getgrav.org/onepage-skeleton',
        'keywords' => 'ledrakkar, spectre, theme, core, modern, fast, responsive, html5, css3',
        'bugs' => 'https://github.com/getgrav/grav-theme-ledrakkar/issues',
        'license' => 'MIT',
        'dependencies' => [
            0 => [
                'name' => 'grav',
        ...
        'form' => [
            ...
            'fields' => [
                'production-mode' => [
                    ...
                    'help' => 'When enabled, Ledrakkar will render with minified CSS',
                    'highlight' => 1,
                    'default' => 1,
                    'options' => [

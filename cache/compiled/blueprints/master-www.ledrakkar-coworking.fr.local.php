...
return [
    ...
    'timestamp' => 1683875265,
    'checksum' => '2aeb47d9505081cd11bfd78646757daf',
    'files' => [
        ...
        'user/themes' => [
            'themes/ledrakkar' => [
                'file' => 'user/themes/ledrakkar/blueprints.yaml',
                'modified' => 1683127733
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.ledrakkar.production-mode' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.ledrakkar.production-mode',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.grid-size' => [
                'type' => 'select',
                ...
                'name' => 'themes.ledrakkar.grid-size',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.header_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.ledrakkar.header_section',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.custom_logo' => [
                'type' => 'file',
                'label' => 'Custom Logo',
                'size' => 'large',
                ...
                'name' => 'themes.ledrakkar.custom_logo',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.custom_logo_mobile' => [
                'type' => 'file',
                ...
                'name' => 'themes.ledrakkar.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.ledrakkar.header-fixed',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.ledrakkar.header-animated',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.ledrakkar.header-dark',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.ledrakkar.header-transparent',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.footer_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.ledrakkar.footer_section',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.ledrakkar.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.blog_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.ledrakkar.blog_section',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.ledrakkar.blog-page',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.spectre_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.ledrakkar.spectre_section',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.spectre' => [
                'type' => '_parent',
                'name' => 'themes.ledrakkar.spectre',
                'form_field' => false
            ],
            'themes.ledrakkar.spectre.exp' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.ledrakkar.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.ledrakkar.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.ledrakkar.spectre.icons',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                'ledrakkar' => [
                    'production-mode' => 'themes.ledrakkar.production-mode',
                    'grid-size' => 'themes.ledrakkar.grid-size',
                    'header_section' => 'themes.ledrakkar.header_section',
                    'custom_logo' => 'themes.ledrakkar.custom_logo',
                    'custom_logo_mobile' => 'themes.ledrakkar.custom_logo_mobile',
                    'header-fixed' => 'themes.ledrakkar.header-fixed',
                    'header-animated' => 'themes.ledrakkar.header-animated',
                    'header-dark' => 'themes.ledrakkar.header-dark',
                    'header-transparent' => 'themes.ledrakkar.header-transparent',
                    'footer_section' => 'themes.ledrakkar.footer_section',
                    'sticky-footer' => 'themes.ledrakkar.sticky-footer',
                    'blog_section' => 'themes.ledrakkar.blog_section',
                    'blog-page' => 'themes.ledrakkar.blog-page',
                    'spectre_section' => 'themes.ledrakkar.spectre_section',
                    'spectre' => [
                        'exp' => 'themes.ledrakkar.spectre.exp',
                        'icons' => 'themes.ledrakkar.spectre.icons'
                    ]
                ],
                'quark' => [
